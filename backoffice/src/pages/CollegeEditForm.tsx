...
const CollegeEditForm = () => {
  ...
  const handleAddDepartment = () => {
    setDepartments([
      ...departments,
      { departmentName: "", description: "", placementPercentage: "" },
    ]);
  };
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    axios
      .post(`http://localhost:5000/admin/updatecollege/${collegeId}`, formData)
      .then((response) => {
        ...
        <div className="w-5/6 p-6">
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            <form onSubmit={handleSubmit}>
              ...
              <div className="dropdown">{/* Dropdown component code */}</div>
              <hr />
              ...
              {courses.map((course: any, index: any) => (
                <div className="form-input-flex-two" key={index}>
                  ...
                  <div className="form-input-group">
                    <label htmlFor={`minQualification${index}`}>
                      Min. Qualification*
                    </label>
                    <input
                      type="text"
                ...
                <div className="form-input-flex-two" key={index}>
                  <div className="form-input-group">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        const updatedDepartments = [...departments];
                        updatedDepartments[index].departmentName =
                          e.target.value;
                        setDepartments(updatedDepartments);
                      }}
                      placeholder="eg: Name"
                  ...
                  <div className="form-input-group">
                    <label htmlFor={`placementPercentage${index}`}>
                      Placement %*
                    </label>
                    <input
                      type="text"
                      ...
                      onChange={(e) => {
                        const updatedDepartments = [...departments];
                        updatedDepartments[index].placementPercentage =
                          e.target.value;
                        setDepartments(updatedDepartments);
                      }}
                      placeholder="Years"
