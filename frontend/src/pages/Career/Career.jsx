...
const Career = () => {
      ...
      content: (
        <>
          ...
          <p>
            ...
            collaborative initiatives. CollegeClub is committed to the cause of
            transforming education in India through our investments in
          ...
          <ul>
            <li>
              Onboard high-quality partners in the Programs, with the potential
              to grow exponentially with the platform.
            </li>
            <li>
              Build a strong pipeline of potential partners, using the existing
              lead leads or by generating new leads, in the high growth
              categories identified for the quarter.
            </li>
            <li>
              Develop a thorough understanding of the internal processes and
              Program guidelines.
            </li>
            <li>
              Fix appointments with the partners, convince them to come onto the
              CollegeClub programs, and assist at every stage of the process
              till the time of completion of services.
            </li>
            <li>
              Collaborating effectively with internal and cross-functional teams
              to solve any seller issues.
            </li>
            <li>
          ...
          <li>
            Outbound/Inbound Calling, Excellent written and verbal communication
            abilities.
          </li>
          <br />
          <h3>Location:</h3>
          ...
          <button
            ...
            className="form-submit-button career-button"
          >
            Apply now
          </button>
        </>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <ul>
            <li>
              Design and develop responsive user interfaces using HTML, CSS, and
              JavaScript.
            </li>
            <li>
              Implement client-side logic with modern front-end frameworks such
              as React, Angular, or Vue.js.
            </li>
            <li>
              Develop and maintain server-side logic using Node.js, Python, or
              other server-side languages.
            </li>
            <li>
              Design and manage databases, write efficient queries, and ensure
              data integrity.
            </li>
            <li>
            ...
            <li>
              Collaborate with designers, product managers, and other team
              members to deliver high-quality software solutions.
            </li>
            <li>
              Conduct unit testing, integration testing, and end-to-end testing
              to ensure the reliability and functionality of applications.
            </li>
            <li>
              Implement security best practices to safeguard applications from
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <ul>
            <li>
              Conduct market research to identify trends, competitor activities,
              and customer preferences.
            </li>
            <li>
              Develop and implement comprehensive marketing strategies to drive
            ...
            <li>
              Collaborate with internal teams to create compelling and on-brand
              marketing materials.
            </li>
            <li>
              Manage and optimize digital marketing efforts, including SEO, SEM,
              social media, and email campaigns.
            </li>
            <li>
              Monitor and analyze key performance indicators (KPIs) to measure
              the success of marketing initiatives.
            </li>
            <li>
              Build and maintain relationships with media outlets, influencers,
              and other key partners.
            </li>
            <li>
              Oversee the planning and execution of events, product launches,
              and other promotional activities.
            </li>
            <li>
              Ensure consistency in brand messaging across all communication
              channels.
            </li>
            <li>
              Prepare and present regular reports on marketing performance and
              insights.
            </li>
            <li>
          ...
          <ul>
            <li>
              ...
              <ul>
                ...
                <li>Proficient in digital marketing tools and platforms.</li>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <h3>Job Overview:</h3>
          <p>
            Are you a recent graduate or someone with a passion for
            [industry/field]? CollegeClub is actively seeking enthusiastic and
            dynamic individuals to join our team as Junior Team Members. If you
            have a knack for collaboration, a thirst for learning, and a desire
            to contribute to exciting projects, we want you on board! This is an
            excellent opportunity for freshers to kick-start their careers and
          ...
          <ul>
            <li>
              ...
              <ul>
                <li>
                  Work closely with cross-functional teams to contribute to
                  ongoing projects and initiatives.
                </li>
                <li>
                  Collaborate with experienced professionals to gain hands-on
            ...
            <li>
              ...
              <ul>
                <li>
                  Participate in training programs designed to enhance your
                  skills and knowledge in [specific skills relevant to your
                  industry].
                </li>
                <li>
                  Embrace continuous learning and growth opportunities within
                  the company.
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul>
                <li>
                  Assist in the execution of projects by providing valuable
                  insights and contributing to project deliverables.
                </li>
                <li>
                  Learn and apply best practices in project management and
                  execution.
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul>
                <li>
                  Develop problem-solving skills by actively engaging in
                  resolving challenges within your assigned projects.
                </li>
                <li>
                  Contribute fresh perspectives to enhance team problem-solving
                  dynamics.
                </li>
              </ul>
            </li>
          ...
          <ul>
            <li>
              ...
              <ul>
                <li>
                  Bachelor's degree in [B.Tech, MBA, BBA, BCA] or equivalent.
                </li>
                ...
                <li>
                  Enthusiastic attitude and a proactive approach to tasks and
                  challenges.
                </li>
              </ul>
            </li>
  ...
  const fetchJobOpenings = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`http://localhost:5000/auth/jobs`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios
        .post(`http://localhost:5000/auth/apply`, {
          name,
          phoneNumber,
          email,
          city,
      ...
      <div className="career">
        ...
        <div className="career-overlay">
          <div className="career-box">
            ...
            {error && <p>Error fetching job openings: {error}</p>}
            {!loading && !error && (
              <Accordion className="accordion" allowZeroExpanded={true}>
                {jobOpenings.map((job, index) => (
                  <AccordionItem key={index}>
                    <AccordionItemHeading>
                      <AccordionItemButton>{job.jobTitle}</AccordionItemButton>
                    </AccordionItemHeading>
                    <AccordionItemPanel className="accordian-contents">
                      <h2>About CollegeClub</h2>
                      ...
                      <ul>
                        {job.jobResponsibilities.map((responsibility, idx) => (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-input-group form-select apply-form-select">
                ...
                >
                  ...
                  {jobOpenings.map((job, index) => (
                    <option key={index} value={job.jobDesignation}>
                      {job.jobTitle}
                    </option>
                  ))}
                </select>
              ...
              <button className="form-submit-button apply-job-button">
                Apply
              </button>
            </form>
          </div>
