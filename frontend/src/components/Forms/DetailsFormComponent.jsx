...
const DetailsFormComponent = () => {
    ...
    const courses = ['Engineering', 'Medical', 'Fashion and Technology', 'Management', 'Commerce and Banking', 'Sciences', 'Hotel Management', 'Information Technology', 'Arts and Humanities', 'Mass Communication', 'Nursing', 'Agriculture', 'Design', 'Law', 'Pharmacy', 'Dental', 'Performing Arts', 'Others'];
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            for (let i = 0; i < coursesCount; i++) {
                ...
                coursesData.push({ courseName, minQualification, duration, fee, distance });
            }
            ...
            for (let i = 0; i < departmentsCount; i++) {
                ...
                departmentsData.push({ departmentName, description, placementPercentage });
            }
            ...
            await axios.post(`http://localhost:5000/auth/detailsform/${userId}`, {
                selectedCourses,
                aboutCollege,
                admissionProcess,
                courses: coursesData,
    ...
    return (
        <div className='details-form'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <h3>About college</h3>
                <textarea onChange={(e) => setAboutCollege(e.target.value)} name="" id="" cols="30" rows="10"></textarea>
                <hr />

                <h3>Admission Process</h3>
                <textarea onChange={(e) => setAdmissionProcess(e.target.value)} name="" id="" cols="30" rows="10"></textarea>
                <hr />
                ...
                {[...Array(coursesCount)].map((_, index) => (
                    <div className="form-input-flex-two" key={index}>
                        <div className="form-input-group">
                            ...
                            <input type="text" name={`courseName${index}`} placeholder='Enter the course name' />
                        </div>

                        <div className="form-input-group">
                            <label htmlFor="collegename">Min. Qualification*</label>
                            {/* <input type="text" placeholder='Add qualification' /> */}
                            <input type="text" name={`minQualification${index}`} placeholder='Add qualification' />
                        </div>

                        <div className="form-input-group">
                            <label htmlFor="collegename">Duration*</label>
                            {/* <input type="text" placeholder='Years' /> */}
                            <input type="text" name={`duration${index}`} placeholder='Years' />
                        </div>
                        ...
                        <div className="form-input-group">
                            ...
                            <input type="text" name={`distance${index}`} placeholder='YES/NO' />
                        </div>

                        <button type='button' className='form-remove-button' onClick={handleRemoveCourse}>Remove</button>
                    </div>
                ))}

                <button type='button' className='form-remove-button form-add-button' onClick={handleAddCourse}>ADD</button>
                <hr />
                ...
                {[...Array(departmentsCount)].map((_, index) => (
                    <div className="form-input-flex-two" key={index}>
                        <div className="form-input-group">
                            ...
                            <input type="text" name={`departmentName${index}`} placeholder='eg: Name' />
                        </div>

                        <div className="form-input-group">
                            <label htmlFor="collegename">Description*</label>
                            {/* <input type="text" placeholder='eg: Details' /> */}
                            <input type="text" name={`description${index}`} placeholder='eg: Details' />
                        </div>

                        <div className="form-input-group">
                            <label htmlFor="collegename">Placement %*</label>
                            {/* <input type="text" placeholder='Years' />    */}
                            <input type="text" name={`placementPercentage${index}`} placeholder='Years' />
                        </div>

                        <button type='button' className='form-remove-button' onClick={handleRemoveDepartment}>Remove</button>
                    </div>
                ))}

                <button type='button' className='form-remove-button form-add-button' onClick={handleAddDepartment}>ADD</button>
                <hr />
                ...
                {[...Array(newsCount)].map((_, index) => (
                    <div className="form-input-flex-two" key={index}>
                        <div className="form-input-group">
                            ...
                            <input type="text" name={`newsTitle${index}`} placeholder='Add news title' />
                        </div>

                        <div className="form-input-group">
                            <label htmlFor="collegename">Ref. Link*</label>
                            {/* <input type="text" placeholder='Add a reference link' /> */}
                            <input type="text" name={`refLink${index}`} placeholder='Add a reference link' />
                        </div>

                        <button type='button' className='form-remove-button' onClick={handleRemoveNews}>Remove</button>
                    </div>
                ))}

                <button type='button' className='form-remove-button form-add-button' onClick={handleAddNews}>ADD</button>
                <hr />
                ...
                {[...Array(rankingCount)].map((_, index) => (
                    <div className="form-input-flex-two" key={index}>
                        <div className="form-input-group">
                            ...
                            <input type="text" name={`agencyName${index}`} placeholder='Add agency name' />
                        </div>

                        <div className="form-input-group">
                            <label htmlFor="collegename">Rank*</label>
                            {/* <input type="text" placeholder='Enter the rank' /> */}
                            <input type="text" name={`rank${index}`} placeholder='Enter the rank' />
                        </div>
                        ...
                        <button type='button' className='form-remove-button' onClick={handleRemoveRanking}>Remove</button>
                    </div>
                ))}

                <button type='button' className='form-remove-button form-add-button' onClick={handleAddRanking}>ADD</button>
                <hr />
                ...
                <div className="form-input-flex-two">
                    <div className="form-input-group">
                        ...
                        <input type="text" onChange={(e) => setOverallPlacement(e.target.value)} placeholder='Enter placement %' />
                    </div>

                    <div className="form-input-group">
                        <label htmlFor="collegename">Promo/Documentary Video*</label>
                        <input type="text" onChange={(e) => setPromo(e.target.value)} placeholder='Enter the promo video link' />
                    </div>

                    <div className="form-input-group">
                        <label htmlFor="collegename">Scholarship offered?*</label>
                        <input type="text" onChange={(e) => setScholarship(e.target.value)} placeholder='YES/NO' />
                    </div>
                </div>
                <hr />
