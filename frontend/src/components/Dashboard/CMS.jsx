    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (selectedImage) {
                ...
                const uploadResponse = await axios.post(`http://localhost:5000/upload/studentprofilepicture/${userId}`, formData);
            ...
            axios.post(`http://localhost:5000/auth/submitstudentdetails/${userId}`, {
                fullName,
                dateOfBirth,
                gender,
                email,
